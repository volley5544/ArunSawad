...
import 'searchableemp_model.dart';
...
class _SearchableempWidgetState extends State<SearchableempWidget> {
  late SearchableempModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchableempModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'searchableemp'});
