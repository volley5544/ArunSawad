                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    ...
                                    'userBName': serializeParam(
                                      listViewChatsRecord.userBName,
                                      ParamType.String,
                                    ),
                                    'userBNickname': serializeParam(
                                      listViewChatsRecord.userBNickname,
                                      ParamType.String,
                                    ),
                                    'userBEmployeeId': serializeParam(
                                      listViewChatsRecord.userBEmployeeId,
                                      ParamType.String,
                                    ),
                                  }.withoutNulls,
                                  extra: <String, dynamic>{
                                                          ...
                                                          children: [
                                                            Padding(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  Text(
                                                                    '${listViewChatsRecord.userBName} (${listViewChatsRecord.userBNickname})',
