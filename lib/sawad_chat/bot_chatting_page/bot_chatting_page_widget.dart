...
import 'bot_chatting_page_model.dart';
export 'bot_chatting_page_model.dart';

class BotChattingPageWidget extends StatefulWidget {
  const BotChattingPageWidget({
    super.key,
  ...
  static String routeName = 'BotChattingPage';
  static String routePath = 'botChattingPage';

  @override
  State<BotChattingPageWidget> createState() => _BotChattingPageWidgetState();
}

class _BotChattingPageWidgetState extends State<BotChattingPageWidget>
    with TickerProviderStateMixin {
  late BotChattingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BotChattingPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'BotChattingPage'});
    // On page load action.
    ...
    return Builder(
      builder: (context) => StreamBuilder<SawadChatRoomRecord>(
        ...
        builder: (context, snapshot) {
          ...
          final botChattingPageSawadChatRoomRecord = snapshot.data!;
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                title: Row(
                  ...
                  children: [
                    if (botChattingPageSawadChatRoomRecord.chatRoomType ==
                        'group')
                      Padding(
                        padding:
              ...
              body: SafeArea(
                ...
                child: Column(
                  ...
                  children: [
                    if (botChattingPageSawadChatRoomRecord != null)
                      Expanded(
                        child: Builder(
                          builder: (context) {
                            final chatDataList = _model.chatData.toList();
                            ...
                            return ListView.separated(
                              ...
                              separatorBuilder: (_, __) =>
                                  SizedBox(height: 8.0),
                              itemBuilder: (context, chatDataListIndex) {
                                final chatDataListItem =
                                    chatDataList[chatDataListIndex];
                                return Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (chatDataListItem.role == 'bot')
                                      Expanded(
                                        child: Padding(
                                          padding:
