...
class AddLeavePageWidget extends StatefulWidget {
  ...
  @override
  _AddLeavePageWidgetState createState() => _AddLeavePageWidgetState();
}
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().update(() {
        ...
        FFAppState().leaveTypeEdit =
            functions.leaveTypeToList1(widget.leaveType)!.toList();
      });
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if (_model.leaveTimeValue == 'ลาเต็มวัน')
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            20.0, 0.0, 10.0, 10.0),
                                        child: Row(
                                                  ...
                                                  _model.leaveRequestAPIOutput2 =
                                                    ...
                                                    leaveReason: _model
                                                        ...
                                                        : _model
                                                            .reasonToLeaveController
                                                            .text,
                                                    leaveCountDay: ((functions.checkSundayBetween2Day(
                                                                        _model
                                                                            .datePicked,
                                                        ...
                                                        ? functions.leaveCountMinusSunday(
                                                            _model.leaveDaysController.text,
                                                            functions.checkSundayBetween2Day(_model.datePicked, functions.endLeaveCalendarDate(_model.datePicked, int.tryParse(_model.leaveDaysController.text))),
                                                            functions.checkHoliDayBetween2Day(
                                                                _model.datePicked,
                                                                functions.endLeaveCalendarDate(_model.datePicked, int.tryParse(_model.leaveDaysController.text)),
                                                  ...
                                                  if ((_model.leaveRequestAPIOutput2
                                                      ...
                                                      if (LeaveRequestFirstAPICall
                                                        ...
                                                        await showDialog(
                                                          ...
                                                          builder:
                                                            ...
                                                            return AlertDialog(
                                                              content: Text(
                                                                  'ไม่พบข้อมูลผู้บังคับบัญชา กรุณาติดต่อ HR'),
                                                              actions: [
                                                                TextButton(
                                                                  onPressed: () =>
                                                                      Navigator.pop(
                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          content: Text(
                                                              'พบข้อผิดพลาด กรุณาทำรายการใหม่'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
