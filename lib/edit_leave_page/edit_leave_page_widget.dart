...
class EditLeavePageWidget extends StatefulWidget {
  ...
  @override
  _EditLeavePageWidgetState createState() => _EditLeavePageWidgetState();
}
          ...
          child: FutureBuilder<List<UserCustomRecord>>(
            future: queryUserCustomRecordOnce(
              queryBuilder: (userCustomRecord) =>
                  userCustomRecord.where('employee_id', isEqualTo: '31622'),
              singleRecord: true,
            ),
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    if ((widget.leaveDocumentOld!.length > 0) &&
                                                  ...
                                                  if ((_model.leaveEditAPIOutput2
                                                    ...
                                                    await showDialog(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          content: Text(
                                                              'พบข้อผิดพลาด (${(_model.leaveEditAPIOutput2?.statusCode ?? 200).toString()})${LeaveEditAPICall.messageLayer1(
                                                            (_model.leaveEditAPIOutput2
                                                                    ?.jsonBody ??
                                                                ''),
                                                          ).toString()}'),
                                                ...
                                                if ((_model.leaveEditAPIOutput
                                                  ...
                                                  await showDialog(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        content: Text(
                                                            'พบข้อผิดพลาด (${(_model.leaveEditAPIOutput?.statusCode ?? 200).toString()})${LeaveEditAPICall.messageLayer1(
                                                          (_model.leaveEditAPIOutput
                                                                  ?.jsonBody ??
                                                              ''),
                                                        ).toString()}'),
