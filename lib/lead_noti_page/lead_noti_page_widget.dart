...
import '/components/call_history_widget.dart';
...
class _LeadNotiPageWidgetState extends State<LeadNotiPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        FFAppState().leadCalledStatusReason =
            (GetLeadDetailAPICall.statusReason(
          (_model.getLeadDetail?.jsonBody ?? ''),
        ) as List)
                .map<String>((s) => s.toString())
                .toList()!
                        ...
                        child: Builder(
                          builder: (context) {
                            ...
                            return SingleChildScrollView(
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: List.generate(leadList.length,
                                    (leadListIndex) {
                                                          ...
                                                          child: Column(
                                                            ...
                                                            children: [
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Padding(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              functions.showLeadTimeRemain(functions.leadTimeRemain(FFAppState().leadCreatedTimeList.toList(), getCurrentTimestamp, leadListIndex)),
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${functions.showMatNameInList(FFAppState().leadCustomerNameList.toList(), leadListIndex)}${' ${functions.showMatNameInList(FFAppState().leadPhoneNumberList.toList(), leadListIndex)}'}',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'Poppins',
                                                              ...
                                                              if ((functions.showMatNameInList(
                                                                          ...
                                                                          leadListIndex) ==
                                                                      'Lead Telesale') &&
                                                                  (functions.checkNullValueAndReturn(functions.showMatNameInList(
                                                                          FFAppState()
                                                                              .leadPhone2
                                                                              .toList(),
                                                                          leadListIndex)) !=
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        '${functions.checkNullValueAndReturn(functions.showMatNameInList(FFAppState().leadName2.toList(), leadListIndex))}${' ${functions.checkNullValueAndReturn(functions.showMatNameInList(FFAppState().leadPhone2.toList(), leadListIndex))} (สำรอง)'}',
                                                                        style: FlutterFlowTheme.of(context)
                                                                            .bodyMedium
                                                                            .override(
                                                                              fontFamily: 'Poppins',
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'หลักทรัพย์: ${functions.showMatNameInList(FFAppState().leadCarVehicleName.toList(), leadListIndex)}',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodySmall
                                                                      .override(
                                                                ...
                                                                padding:
                                                                    EdgeInsetsDirectional
                                                                        .fromSTEB(
                                                                            ...
                                                                            0.0),
                                                                child: Text(
                                                                  'ยอดขอ: ${functions.returnNumberWithComma2Decimal(functions.showMatNameInList(FFAppState().leadAmountRequest.toList(), leadListIndex))} บาท',
                                                                  style: FlutterFlowTheme.of(
                                                                          context)
                                                                      .bodySmall
                                                                      .override(
                                                      ...
                                                      FFButtonWidget(
                                                        onPressed: () async {
                                                          ...
                                                          _model.getCalledStatusCode =
                                                            ...
                                                            token: FFAppState()
                                                                .accessToken,
                                                            leadChannel: functions.getLeadChannelCode(
                                                                functions.showMatNameInList(
                                                                    FFAppState()
                                                                        .leadChannelList
                                                                        .toList(),
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      leadChannel: functions.showMatNameInList(
                                                                          FFAppState()
                                                                              .leadChannelList
                                                                              .toList(),
                                                                          leadListIndex),
                                                                      leadId: functions.showMatNameInList(
                                                                          FFAppState()
                                                                              ...
                                                                              .toList(),
                                                                          leadListIndex),
                                                                      callStatusId: (GetLeadCalledStatusDropdownAPICall
                                                                              .callStatusId(
                                                                        (_model.getCalledStatusCode?.jsonBody ??
                                                                          ...
                                                                          .toList()
                                                                          ?.toList(),
                                                                      callStatussName: (GetLeadCalledStatusDropdownAPICall
                                                                              .callStatusName(
                                                                        (_model.getCalledStatusCode?.jsonBody ??
                                                                            ''),
                                                                      ) as List)
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        callStatusList: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.callStatus(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                        ...
                                                                        historyStatusList: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            ? FFAppState().defaultList1
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.historyStatus(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                        ...
                                                                        historyTimeCallList: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            ? FFAppState().defaultList1
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.callTime(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                        ...
                                                                        employeeIdList: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            ? FFAppState().defaultList1
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.employeeId(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                        ...
                                                                        reasonNameList: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            ? FFAppState().defaultList1
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.reasonName(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
                                                                        ...
                                                                        note: GetLeadCalledHistoryAPICall.statusLayer2(
                                                                            ...
                                                                            ? FFAppState().defaultList1
                                                                            : functions
                                                                                .reverseList((GetLeadCalledHistoryAPICall.note(
                                                                                  (_model.getCallHistory?.jsonBody ?? ''),
                                                                                ) as List)
                                                                                    .map<String>((s) => s.toString())
                                                                                    .toList()
