...
import 'car_seized_page_step1_model.dart';
export 'car_seized_page_step1_model.dart';
...
class _CarSeizedPageStep1WidgetState extends State<CarSeizedPageStep1Widget> {
  late CarSeizedPageStep1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CarSeizedPageStep1Model());
