  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (widget!.step == 'step1') {
        if (!(('${widget!.impoundCarLocateParamSet?.impoundLocatBranchCode}' !=
                '') &&
            ('${widget!.impoundCarLocateParamSet?.impoundLocatBranchCode}' !=
                'null'))) {
          return;
        }
      } else {
      ...
      _model.branchSearchOutput = await ImproundCarSearchBranchCall.call(
        branchCode: widget!.impoundCarLocateParamSet?.impoundLocatBranchCode,
        apiUrl: FFAppState().impoundUrlVloan,
        token: FFAppState().impoundUrlVloanToken,
      );

      if ((_model.branchSearchOutput?.statusCode ?? 200) != 200) {
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(
                    'พบข้อผิดพลาด Connection(${(_model.branchSearchOutput?.statusCode ?? 200).toString()})'),
                actions: [
                  TextButton(
      ...
      if ('${getJsonField(
            (_model.branchSearchOutput?.jsonBody ?? ''),
            r'''$.code''',
          ).toString()}' !=
          '200') {
        Navigator.pop(context);
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.uploadedLocalFile_carUploaded01 == null ||
                                  ...
                                  if (_shouldSetState) safeSetState(() {});
                                  return;
                                } else if (_model.uploadedLocalFile_carUploaded08 == null ||
                                    (_model.uploadedLocalFile_carUploaded08.bytes?.isEmpty ?? true)) {
                                  await showDialog(
                                    context: context,
                                    builder: (alertDialogContext) {
                                      return WebViewAware(
                                ...
                                _model.uploadGoogleDriveApiOutput =
                                  ...
                                  images12:
                                      _model.uploadedLocalFile_carUploaded12,
                                  cuscod: widget!
                                      .impoundCarParamSet?.improundCUSCOD,
                                  ...
                                  statusName: (widget!.step != 'step1') &&
                                      ...
                                      : '',
                                  originYear: widget!
                                      .impoundCarParamSet?.improundMANUYR,
                                  convertYear: widget!.impoundCarParamSet
                                      ?.improundMANUYRCONVERT,
                                  improundcarLocatId: widget!
                                      .impoundCarLocateParamSet
                                      ?.improundcarLocatId,
                                  locatCode: widget!
                                      .impoundCarLocateParamSet?.locatCode,
                                  locatName: widget!
                                      .impoundCarLocateParamSet?.locatName,
                                  ...
                                  typecod: widget!
                                      .impoundCarParamSet?.improundTYPECOD,
                                  modelcod: widget!
                                      .impoundCarParamSet?.improundMODELCOD,
                                  colorcod: widget!
                                      .impoundCarParamSet?.improudCOLORCOD,
                                  address:
                                      widget!.impoundCarLocateParamSet?.address,
                                  subDistrict: widget!
                                      .impoundCarLocateParamSet?.subDistrict,
                                  district: widget!
                                      .impoundCarLocateParamSet?.district,
                                  province: widget!
                                      .impoundCarLocateParamSet?.province,
                                  postcode: widget!
                                      .impoundCarLocateParamSet?.postcode,
                                  phoneNumber: widget!
                                      .impoundCarLocateParamSet?.phoneNumber,
                                  latitude: widget!
                                      .impoundCarLocateParamSet?.latitude,
                                  longitude: widget!
                                      .impoundCarLocateParamSet?.longitude,
                                  branchCodeLocat: widget!
                                      .impoundCarLocateParamSet
                                      ?.branchCodeLocat,
                                  areaCode: widget!
                                      .impoundCarLocateParamSet?.areaCode,
                                  areaName: widget!
                                      .impoundCarLocateParamSet?.areaName,
                                  regionCode: widget!
                                  ...
                                  receiver: ((FFAppState().profileLevel == 'สาขา') ||
                                          ...
                                          : functions.containsValueInJsonList(
                                              ...
                                              widget!.userRoleSave)!)
                                      ? widget!
                                          .impoundCarLocateParamSet?.receiver
                                      : '',
                                  images17:
                                      _model.uploadedLocalFile_carUploaded13,
