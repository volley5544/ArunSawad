...
import 'checker_page_model.dart';
export 'checker_page_model.dart';
...
class CheckerPageWidget extends StatefulWidget {
  ...
  static String routeName = 'CheckerPage';
  static String routePath = 'checkerPage';

  @override
  State<CheckerPageWidget> createState() => _CheckerPageWidgetState();
}

class _CheckerPageWidgetState extends State<CheckerPageWidget>
    with TickerProviderStateMixin {
  late CheckerPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CheckerPageModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'CheckerPage'});
    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if (!FFAppState().isFromTimesheetPage) {
        ...
        await userLogRecordReference.set(createUserLogRecordData(
          ...
          action: 'Branch_View_Checker',
          actionTime: getCurrentTimestamp,
          userLocation: currentUserLocationValue,
        ));
        _model.createdUserLogBVChecker = UserLogRecord.getDocumentFromData(
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          top: true,
          child: FutureBuilder<List<BranchviewDropdownRecord>>(
            ...
            builder: (context, snapshot) {
              ...
              List<BranchviewDropdownRecord>
                  columnBranchviewDropdownRecordList = snapshot.data!;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          ...
                                          child: TextFormField(
                                            controller: _model
                                                .contnoInputTextController,
                                            focusNode:
                                                _model.contnoInputFocusNode,
                                            autofocus: false,
                                            readOnly: true,
                                            obscureText: false,
                                            decoration: InputDecoration(
                                      ...
                                      onPressed: () async {
                                        ...
                                        _model.getVloanContract =
                                          ...
                                          cuscod: _model
                                              .idInputTextController2.text,
                                          token: FFAppState()
                                              .tokenVloanGetContract,
                                          apiUrl: FFAppState()
                                              .apiUrlVloanGetContract,
                                        );
                              ...
                              child: Wrap(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child:
                                        FutureBuilder<List<FileUploadRecord>>(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      if (!(_model.remarkInput33TextController
                                                  .text !=
                                              null &&
                                          _model.remarkInput33TextController
                                                  .text !=
                                              '')) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return WebViewAware(
                                              child: AlertDialog(
                                                content: Text(
                                                    'จำนวนตัวอักษรของ \"หมายเหตุ\" มากเกินไป (สูงสุด ${columnBranchviewDropdownRecord?.remarkMaxLength?.toString()} ตัวอักษร)'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () =>
                                                        Navigator.pop(
                                      ...
                                      if (CheckerAPICall.status(
                                        ...
                                        if (functions.checkStringLength(
                                                '${functions.generateBranchViewVloneRemark(functions.checkStringLength(functions.generateBranchViewMapLink(CheckerAPICall.recordID(
                                                      (_model.checkerAPISubmit
                                                              ?.jsonBody ??
                                                          ''),
                                                    ))), _model.remarkInput33TextController.text, columnBranchviewDropdownRecord?.vloanMsgMaxLength)} ${functions.generateBranchViewMapLink(CheckerAPICall.recordID(
                                              (_model.checkerAPISubmit
                                                      ?.jsonBody ??
                                                  ''),
                                            ))}') >
                                        ...
                                        var vLoanRemarkLogRecordReference =
                                            VLoanRemarkLogRecord.collection
                                                .doc();
                                        await vLoanRemarkLogRecordReference
                                            .set({
                                        ...
                                        await showDialog(
                                          ...
                                          builder: (alertDialogContext) {
                                            return WebViewAware(
                                              child: AlertDialog(
                                                content: Text(
                                                    'พบข้อผิดพลาด (${CheckerAPICall.status(
                                                  (_model.checkerAPISubmit
                                                          ?.jsonBody ??
                                                      ''),
                                      ...
                                      context
                                          .goNamed(SuccessPageWidget.routeName);
