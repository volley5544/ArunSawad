...
import 'insurance_request_dashboard_page_model.dart';
export 'insurance_request_dashboard_page_model.dart';

class InsuranceRequestDashboardPageWidget extends StatefulWidget {
  const InsuranceRequestDashboardPageWidget({
    super.key,
    this.jwtToken,
  });
  ...
  State<InsuranceRequestDashboardPageWidget> createState() =>
      _InsuranceRequestDashboardPageWidgetState();
}

class _InsuranceRequestDashboardPageWidgetState
    extends State<InsuranceRequestDashboardPageWidget>
    with TickerProviderStateMixin {
  late InsuranceRequestDashboardPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InsuranceRequestDashboardPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'InsuranceRequestDashboardPage'});
    // On page load action.
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ClipRRect(
                                          ...
                                          child: Image.asset(
                                            'assets/images/Screenshot_2566-08-13_at_13.53.03.png',
                                            width: double.infinity,
                                            height: 115.0,
                                            fit: BoxFit.contain,
                                          ),
