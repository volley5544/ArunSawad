...
import 'super_app_new_page_widget.dart' show SuperAppNewPageWidget;
...
class SuperAppNewPageModel extends FlutterFlowModel<SuperAppNewPageWidget> {
  ...
  // Stores action output result for [Custom Action - a14] action in SuperAppNewPage widget.
  String? leadNotiOutput;
  // Stores action output result for [Custom Action - a17] action in SuperAppNewPage widget.
  bool? checkDoNotShowIsEmpty;
  // Stores action output result for [Custom Action - a18] action in SuperAppNewPage widget.
  bool? checkDoNotShowHoliday;
  // Stores action output result for [Custom Action - a18] action in SuperAppNewPage widget.
  bool? checkDoNotShow;
  // Stores action output result for [Backend Call - API (getDateTimeAPI)] action in SuperAppNewPage widget.
