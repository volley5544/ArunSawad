...
class _PinCodePageWidgetState extends State<PinCodePageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return Builder(
      builder: (context) => FutureBuilder<List<SplashPageImgRecord>>(
                                                  ...
                                                  queryBuilder:
                                                      (userCustomRecord) =>
                                                          userCustomRecord
                                                              .where(
                                                    'employee_id',
                                                    isEqualTo: functions.checkIntFromString(
                                                            FFAppState()
                                                                .employeeID)!
                                                        ? (valueOrDefault(
                                                                    currentUserDocument
                                                        ...
                                                        : FFAppState().employeeID !=
                                                                ''
                                                            ? functions.checkIntFromString(
                                                                    FFAppState()
                                                                        .employeeID)!
                                                                ? (valueOrDefault(currentUserDocument?.employeeId, 0) >=
                                                                        100000
                                                                    ? valueOrDefault(currentUserDocument?.employeeId, 0)
                                                                        .toString()
                                                                    : FFAppState()
                                                                  ...
                                                                  children: [
                                                                    FutureBuilder<
                                                                      ...
                                                                      future:
                                                                        ...
                                                                        queryBuilder:
                                                                          ...
                                                                          isEqualTo: functions.checkIntFromString(FFAppState().employeeID)!
                                                                              ? (valueOrDefault(currentUserDocument?.employeeId, 0) >= 100000 ? valueOrDefault(currentUserDocument?.employeeId, 0).toString() : FFAppState().employeeID)
                                                                              : FFAppState().employeeID != ''
                                                                                  ? functions.checkIntFromString(FFAppState().employeeID)!
                                                                                      ? (valueOrDefault(currentUserDocument?.employeeId, 0) >= 100000 ? valueOrDefault(currentUserDocument?.employeeId, 0).toString() : FFAppState().employeeID)
                                                                                      : FFAppState().employeeID
                                                                                  : null,
                                                                        ),
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        List<UserCustomRecord>
                                                                            ...
                                                                            snapshot.data!;
                                                                        final containerUserCustomRecord = containerUserCustomRecordList.isNotEmpty
                                                                    ...
                                                                    StreamBuilder<
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        final columnAuthorizationRecord = columnAuthorizationRecordList.isNotEmpty
                                                                        ...
                                                                        return Column(
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: StreamBuilder<List<InsuranceNotiDataRecord>>(
                                                                                                      ...
                                                                                                      Column(
                                                                                                        ...
                                                                                                        children: [
                                                                                                          ...
                                                                                                          Padding(
                                                                                                            ...
                                                                                                            child: Text(
                                                                                                              'กดเพื่อตั้งค่าใช้งาน ${isAndroid ? 'สแกนลายนิ้วมือ' : 'Face id'}',
                                                                                                              style: FlutterFlowTheme.of(context).headlineSmall.override(
                                                                                                                    font: GoogleFonts.poppins(
                                                                                                                      fontWeight: FlutterFlowTheme.of(context).headlineSmall.fontWeight,
                                                                                                                      fontStyle: FlutterFlowTheme.of(context).headlineSmall.fontStyle,
