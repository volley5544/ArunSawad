...
import '/index.dart';
import 'search_employee_page2_widget.dart' show SearchEmployeePage2Widget;
...
class SearchEmployeePage2Model
    extends FlutterFlowModel<SearchEmployeePage2Widget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Firestore Query - Query a collection] action in SearchEmployeePage2 widget.
