...
import 'info_report_model.dart';
export 'info_report_model.dart';
...
class _InfoReportWidgetState extends State<InfoReportWidget>
    with TickerProviderStateMixin {
  late InfoReportModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InfoReportModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'InfoReport'});
    // On page load action.
                    ...
                    children: [
                      RatingBar.builder(
                        ...
                        initialRating: _model.ratingBarValue ??=
                          ...
                          FFAppState().RatingNumber.toDouble(),
                          0.0,
                        ),
                        unratedColor: Color(0xFF9E9E9E),
                        itemCount: 5,
                        itemSize: 40.0,
                        glowColor: Color(0xFFF3E743),
                      ),
                      SelectionArea(
                          child: Text(
