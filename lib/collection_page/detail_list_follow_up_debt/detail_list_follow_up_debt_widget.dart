      ...
      child: PopScope(
        ...
        child: Scaffold(
          ...
          body: SafeArea(
            top: true,
            child: Visibility(
              visible: (_model.getListDataPerson?.statusCode ?? 200) == 200,
              child: Column(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          context
                                                                              .pushNamed(
                                                                            RecordFollowUpDebtWidget.routeName,
                                                                            queryParameters:
                                                                                {
                                                                              'contNo': serializeParam(
                                                                                getJsonField(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Checkbox(
                                                                        value: _model.checkboxValueMap[listCardItem] ??=
                                                                            false,
                                                                        onChanged:
                                                                            (newValue) async {
                                                                          safeSetState(() =>
                                                                              _model.checkboxValueMap[listCardItem] = newValue!);
                                                                          if (newValue!) {
                                                                            HapticFeedback.mediumImpact();
                                                                            FFAppState().updateSelectCardListAtIndex(
                                                                              listCardIndex,
                                                                              (_) => true,
                                                                            );
                                                                            safeSetState(() {});
                                                                        ...
                                                                        side: (FlutterFlowTheme.of(context).primaryBackground !=
                                                                                null)
                                                                            ? BorderSide(
                                                                                width: 2,
