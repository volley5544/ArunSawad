...
class _TabCollectionWidgetState extends State<TabCollectionWidget>
  ...
  var hasRowTriggered14 = false;
  var hasRowTriggered15 = false;
  var hasRowTriggered16 = false;
  ...
  void initState() {
    ...
    animationsMap.addAll({
      ...
      'rowOnActionTriggerAnimation13': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnActionTriggerAnimation15': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: false,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnPageLoadAnimation16': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        applyInitialState: false,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnActionTriggerAnimation16': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: false,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnPageLoadAnimation17': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        applyInitialState: true,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnActionTriggerAnimation17': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnPageLoadAnimation18': AnimationInfo(
        trigger: AnimationTrigger.onPageLoad,
        applyInitialState: true,
        effectsBuilder: () => [
          MoveEffect(
      ...
      'rowOnActionTriggerAnimation18': AnimationInfo(
        trigger: AnimationTrigger.onActionTrigger,
        applyInitialState: true,
        effectsBuilder: () => [
          MoveEffect(
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      animationsMap['rowOnPageLoadAnimation14']!.controller.forward(from: 0.0);
      animationsMap['rowOnPageLoadAnimation15']!.controller.forward(from: 0.0);
      animationsMap['rowOnPageLoadAnimation16']!.controller.forward(from: 0.0);
    });
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Align(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    valueOrDefault<
                                                                        String>(
                                                                      CollectionApiGetDataCountPPCall.statusCode(
                                                                                (_model.apiOutputCountPP?.jsonBody ?? ''),
                                                                              ) ==
                                                                              200
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Builder(
                                        builder: (context) {
                                          final provinceData =
                                              _model.slsDataPageState.toList();
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                                (context, provinceDataIndex) {
                                              final provinceDataItem =
                                                  provinceData[
                                                      provinceDataIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                ...
                                                child: InkWell(
                                                  ...
                                                  onTap: () async {
                                                    _model.cathayTabState = 2;
                                                    _model.cathayProvince =
                                                        provinceDataItem
                                                            .province;
                                                    _model.provinceIndex =
                                                        provinceDataIndex;
                                                    safeSetState(() {});
                                                  },
                                                  child: Material(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                                (context, districtDataIndex) {
                                              final districtDataItem =
                                                  districtData[
                                                      districtDataIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                                ...
                                                child: InkWell(
                                                  ...
                                                  highlightColor:
                                                      Colors.transparent,
                                                  onTap: () async {
                                                    _model.cathayDistrict =
                                                        districtDataItem
                                                            .districtName;
                                                    _model.cathayTabState = 3;
                                                    _model.districtIndex =
                                                        districtDataIndex;
                                                    safeSetState(() {});
                                                  },
                                                  child: Material(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          valueOrDefault<
                                                                              String>(
                                                                            functions.showNumberWithComma(districtDataItem.districtsCount.toString()),
                                                                            '0',
                                                                          ),
                                                                          textAlign:
                                                                              TextAlign.center,
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                                (context, subdistrictsIndex) {
                                              final subdistrictsItem =
                                                  subdistricts[
                                                      subdistrictsIndex];
                                              return Padding(
                                                padding: EdgeInsetsDirectional
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      .animateOnActionTrigger(
                                          ...
                                          hasBeenTriggered: hasRowTriggered14),
                                ),
                                Padding(
                                  padding: EdgeInsetsDirectional.fromSTEB(
                                      0.0, 20.0, 0.0, 0.0),
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      .animateOnActionTrigger(
                                          animationsMap[
                                              'rowOnActionTriggerAnimation15']!,
                                          hasBeenTriggered: hasRowTriggered15),
                                ),
                                if (false)
                                  Column(
                                    mainAxisSize: MainAxisSize.max,
                                      ...
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            .animateOnPageLoad(animationsMap[
                                                'rowOnPageLoadAnimation16']!)
                                            .animateOnActionTrigger(
                                                animationsMap[
                                                    'rowOnActionTriggerAnimation16']!,
                                                hasBeenTriggered:
                                                    hasRowTriggered16),
                                      ),
                                      Padding(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            .animateOnPageLoad(animationsMap[
                                                'rowOnPageLoadAnimation17']!)
                                            .animateOnActionTrigger(
                                              animationsMap[
                                                  'rowOnActionTriggerAnimation17']!,
                                            ),
                                      ),
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            .animateOnPageLoad(animationsMap[
                                                'rowOnPageLoadAnimation18']!)
                                            .animateOnActionTrigger(
                                              animationsMap[
                                                  'rowOnActionTriggerAnimation18']!,
                                            ),
                                      ),
                                    ],
                                  ),
