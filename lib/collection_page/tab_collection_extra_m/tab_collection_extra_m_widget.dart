...
import 'tab_collection_extra_m_model.dart';
export 'tab_collection_extra_m_model.dart';

class TabCollectionExtraMWidget extends StatefulWidget {
  const TabCollectionExtraMWidget({super.key});

  static String routeName = 'tabCollectionExtraM';
  static String routePath = 'tabCollectionExtraM';

  @override
  State<TabCollectionExtraMWidget> createState() =>
      _TabCollectionExtraMWidgetState();
}

class _TabCollectionExtraMWidgetState extends State<TabCollectionExtraMWidget>
    with TickerProviderStateMixin {
  late TabCollectionExtraMModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TabCollectionExtraMModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'tabCollectionExtraM'});
    // On page load action.
      ...
      if (!FFAppState().isProductionNew) {
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(FFAppState().apiUrlBranchViewCollection),
                actions: [
                  TextButton(
      ...
      if (CollectionApiGetDataCountExtraMCall.statusCode(
        ...
        await showDialog(
          ...
          builder: (alertDialogContext) {
            return WebViewAware(
              child: AlertDialog(
                content: Text(CollectionApiGetDataCountExtraMCall.message(
                  (_model.collectionApiGetdataCountM?.jsonBody ?? ''),
                )!),
                actions: [
                  TextButton(
            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Builder(
                    builder: (context) {
                      final listExtraM = _model.dataTab.toList();
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, listExtraMIndex) {
                          final listExtraMItem = listExtraM[listExtraMIndex];
                          return Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 20.0, 0.0, 0.0),
                            child: Row(
