...
import 'search_collection_page_model.dart';
export 'search_collection_page_model.dart';

class SearchCollectionPageWidget extends StatefulWidget {
...
class _SearchCollectionPageWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchCollectionPageModel());
