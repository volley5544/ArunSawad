                                                      ...
                                                      ?.elementAtOrNull(functions
                                                          .getIndexOfSomethingList(
                                                              ...
                                                              _model
                                                                  .dropDownFollowupValue)))) !=
                                              'Hello World') ||
                                          (_model.dropDownFollowupValue == 'RP82') ||
                                          (_model.dropDownFollowupValue == 'RP84')))
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 10.0),
                                      child: Row(
                                                                  ...
                                                                  await showDialog<
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              content: Text('คุณต้องการจะลบรูปหรือไม่?'),
                                                                              actions: [
                                                                                TextButton(
                                      ...
                                      onPressed: () async {
                                        ...
                                        _model.collectionAPISubmit1 =
                                          ...
                                          customerName:
                                              '${widget!.firstname} ${widget!.lastname}',
                                          remark:
                                              '${functions.generateBranchViewVloneRemark(functions.checkStringLength(''), '${_model.dropDownFollowupValue}_[ผู้ติดตามหนี้: ${FFAppState().employeeID}]_${_model.remarkTextFieldTextController.text}', columnBranchviewDropdownRecord?.vloanMsgMaxLength)}',
                                          uid: FFAppState().imei,
                                          ...
                                          if (functions.checkStringLength(
                                                  '${functions.generateBranchViewVloneRemark(functions.checkStringLength(functions.generateBranchViewMapLink(CollectionAPICall.recordID(
                                                        (_model.collectionAPISubmit1
                                                                ?.jsonBody ??
                                                            ''),
                                                      ))), _model.remarkTextFieldTextController.text, columnBranchviewDropdownRecord?.vloanMsgMaxLength)} ${functions.generateBranchViewMapLink(CollectionAPICall.recordID(
                                                (_model.collectionAPISubmit1
                                                        ?.jsonBody ??
                                                    ''),
                                              ))}') >
                                          ...
                                          _model.remarkVLoneOutput =
                                            ...
                                            msg: '${functions.generateBranchViewVloneRemark(functions.checkStringLength(functions.generateBranchViewMapLink(CollectionAPICall.recordID(
                                                  (_model.collectionAPISubmit1
                                                          ?.jsonBody ??
                                                      ''),
                                                ))), '${_model.dropDownFollowupValue}_[ผู้ติดตามหนี้: ${FFAppState().employeeID}]_${_model.remarkTextFieldTextController.text} ดูข้อมูลเพิ่มเติม ', columnBranchviewDropdownRecord?.vloanMsgMaxLength)} ${functions.generateBranchViewMapLink(CollectionAPICall.recordID(
                                              (_model.collectionAPISubmit1
                                                      ?.jsonBody ??
                                                  ''),
                                            ))}',
