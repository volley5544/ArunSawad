...
import '/index.dart';
import 'team_m_select_branch_page_widget.dart' show TeamMSelectBranchPageWidget;
...
class TeamMSelectBranchPageModel
    extends FlutterFlowModel<TeamMSelectBranchPageWidget> {
  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - Create Document] action in TeamMSelectBranchPage widget.
  UserLogRecord? createdUserLogBsiReport;
  // Stores action output result for [Backend Call - API (GetlocationAPI)] action in TeamMSelectBranchPage widget.
