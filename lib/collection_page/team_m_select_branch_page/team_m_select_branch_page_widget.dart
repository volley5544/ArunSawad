...
import 'team_m_select_branch_page_model.dart';
export 'team_m_select_branch_page_model.dart';

class TeamMSelectBranchPageWidget extends StatefulWidget {
  const TeamMSelectBranchPageWidget({super.key});

  static String routeName = 'TeamMSelectBranchPage';
  static String routePath = 'teamMSelectBranchPage';

  @override
  State<TeamMSelectBranchPageWidget> createState() =>
      _TeamMSelectBranchPageWidgetState();
}

class _TeamMSelectBranchPageWidgetState
    extends State<TeamMSelectBranchPageWidget> with TickerProviderStateMixin {
  late TeamMSelectBranchPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TeamMSelectBranchPageModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'TeamMSelectBranchPage'});
    // On page load action.
    ...
    return FutureBuilder<List<UrlLinkStorageRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UrlLinkStorageRecord>
            teamMSelectBranchPageUrlLinkStorageRecordList = snapshot.data!;
        final teamMSelectBranchPageUrlLinkStorageRecord =
            teamMSelectBranchPageUrlLinkStorageRecordList.isNotEmpty
                ? teamMSelectBranchPageUrlLinkStorageRecordList.first
                : null;
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Column(
                              ...
                              children: [
                                ...
                                if (_model.branchDropDownValue != null &&
                                    _model.branchDropDownValue != '')
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        24.0, 12.0, 24.0, 0.0),
                                          ...
                                          child: FFButtonWidget(
                                            onPressed: () async {
                                              ...
                                              await actions.openTableauBrowser(
                                                ...
                                                '${teamMSelectBranchPageUrlLinkStorageRecord?.urlLink}/${_model.reportDropDownValue}',
                                                FFAppState()
