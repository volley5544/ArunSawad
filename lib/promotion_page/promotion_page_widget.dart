...
import '/components/p_d_f_viewer_thaipaiboon_widget.dart';
...
class PromotionPageWidget extends StatefulWidget {
  const PromotionPageWidget({Key? key}) : super(key: key);

  @override
  _PromotionPageWidgetState createState() => _PromotionPageWidgetState();
}
