...
class ConfirmEmailPageWidget extends StatefulWidget {
  const ConfirmEmailPageWidget({Key? key}) : super(key: key);

  @override
  _ConfirmEmailPageWidgetState createState() => _ConfirmEmailPageWidgetState();
}
...
class _ConfirmEmailPageWidgetState extends State<ConfirmEmailPageWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'ConfirmEmailPage'});
