...
import '/components/input_copy2_copy_widget.dart';
...
class LeaveShowPageCopyWidget extends StatefulWidget {
  const LeaveShowPageCopyWidget({Key? key}) : super(key: key);

  @override
  _LeaveShowPageCopyWidgetState createState() =>
                                                                  ...
                                                                  children: [
                                                                    SelectionArea(
                                                                      ...
                                                                      valueOrDefault<
                                                                          String>(
                                                                        functions
                                                                            .leaveStatusToText(valueOrDefault<String>(
                                                                          functions.showMatNameInList(
                                                                              functions
