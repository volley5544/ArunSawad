...
class EmployeeKpiCEOPageWidget extends StatefulWidget {
  const EmployeeKpiCEOPageWidget({Key? key}) : super(key: key);

  @override
  _EmployeeKpiCEOPageWidgetState createState() =>
...
class _EmployeeKpiCEOPageWidgetState extends State<EmployeeKpiCEOPageWidget>
  ...
  void initState() {
    ...
    _model.branchInputAreaController ??= TextEditingController();
    setupAnimations(
                      ...
                      children: [
                        Column(
                          ...
                          children: [
                            ...
                            if (((_model.getBudget?.statusCode ?? 200) ==
                                    200) &&
                                    ...
                                    Text(
                                      valueOrDefault<String>(
                                        'พื้นที่ : ${functions.showMatNameInList((GetTargetBudgetKpiCEOAPICall.areaTypeCM(
                                              (_model.getBudget?.jsonBody ??
                                                  ''),
                                            ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList(), 0)}',
                                        'พื้นที่ : ...',
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                                          ...
                                                          valueOrDefault<
                                                            ...
                                                            'รหัสพนักงาน: ${functions.showMatNameInList((GetTargetBudgetKpiCEOAPICall.employeeID(
                                                                  (_model.getBudget
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List).map<String>((s) => s.toString()).toList()?.toList(), actualBudgetIndex)}',
                                                            'รหัสพนักงาน: -',
                                                          ),
                                                        ...
                                                        Text(
                                                          valueOrDefault<
                                                            ...
                                                            functions.showMatNameInList(
                                                                (GetTargetBudgetKpiCEOAPICall.ageOfPositionCM(
                                                                  (_model.getBudget
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List)
                                                          ...
                                                          children: [
                                                            ...
                                                            Text(
                                                              valueOrDefault<
                                                                ...
                                                                functions
                                                                    .checkMeanBudgetKPI(
                                                                        functions.removeCommaFromNumText(valueOrDefault<
                                                                            String>(
                                                                          functions.showMatNameInList(
                                                                              (GetTargetBudgetKpiCEOAPICall.actual(
                                                                                (_model.getBudget?.jsonBody ?? ''),
                                                                        ...
                                                                        functions
                                                                            .removeCommaFromNumText(valueOrDefault<String>(
                                                                          functions.showMatNameInList(
                                                                              (GetTargetBudgetKpiCEOAPICall.targetBudget(
                                                                                (_model.getBudget?.jsonBody ?? ''),
                                                                              ) as List)
                                                          ...
                                                          valueOrDefault<
                                                            ...
                                                            'รหัสพนักงาน: ${functions.showMatNameInList(functions.createContractKpiEmpIdList((GetTargetContractKpiCEOAPICall.employeeID(
                                                                  (_model.getContract
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List).map<String>((s) => s.toString()).toList()?.toList())?.toList(), employeeIdListIndex)}',
                                                            'รหัสพนักงาน: -',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                                    ...
                                                                    children: [
                                                                      Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          Text(
                                                                            functions.stringDoubleToStringInt(valueOrDefault<String>(
                                                                              functions.showMatNameInList(
                                                                                  (GetTargetContractKpiCEOAPICall.actual(
                                                                                    (_model.getContract?.jsonBody ?? ''),
                                                                                  ) as List)
                                                          ...
                                                          valueOrDefault<
                                                            ...
                                                            'รหัสพนักงาน: ${functions.showMatNameInList((GetTargetBudgetKpiCEOAPICall.employeeIdLM(
                                                                  (_model.getBudget
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List).map<String>((s) => s.toString()).toList()?.toList(), actualBudgetLMIndex)}',
                                                            'รหัสพนักงาน: -',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                      ...
                                                      children: [
                                                        Text(
                                                          valueOrDefault<
                                                              String>(
                                                            functions.showMatNameInList(
                                                                (GetTargetBudgetKpiCEOAPICall.ageOfPositionLM(
                                                                  (_model.getBudget
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List)
                                                          ...
                                                          valueOrDefault<
                                                            ...
                                                            'รหัสพนักงาน: ${functions.showMatNameInList(functions.createContractKpiEmpIdList((GetTargetContractKpiCEOAPICall.employeeIdLM(
                                                                  (_model.getContract
                                                                          ?.jsonBody ??
                                                                      ''),
                                                                ) as List).map<String>((s) => s.toString()).toList()?.toList())?.toList(), employeeIdListLMIndex)}',
                                                            'รหัสพนักงาน: -',
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                        ...
                        Column(
                          ...
                          children: [
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Expanded(
                                                ...
                                                child: TextFormField(
                                                  controller: _model
                                                      .employeeKeywordInputController,
                                                  obscureText: false,
                                                  decoration: InputDecoration(
                                                    labelStyle:
                                                        FlutterFlowTheme.of(
                                                        ...
                                                        if (GetEmployeeIdFromNicknameAPICall
                                                          ...
                                                          await showDialog(
                                                            ...
                                                            builder:
                                                                (alertDialogContext) {
                                                              return AlertDialog(
                                                                content: Text(functions.showMatNameInList(
                                                                    (GetEmployeeIdFromNicknameAPICall.detailMessage(
                                                                      (_model.getEmployeeSearched
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    ) as List)
                            ...
                            if (((_model.getEmployeeBudget?.statusCode ??
                                        200) ==
                                    200) &&
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          valueOrDefault<
                                                            ...
                                                            functions
                                                                .checkMeanBudgetKPI(
                                                                    functions.removeCommaFromNumText(GetEmpTargetBudgetKPIAPICall
                                                                            .actual(
                                                                      (_model.getEmployeeBudget
                                                                              ?.jsonBody ??
                                                                          ''),
                                                      ...
                                                      valueOrDefault<String>(
                                                        'รหัสพนักงาน: ${functions.showMatNameInList((GetEmpTargetContractKPIAPICall.employeeIdTM(
                                                              (_model.getEmployeeContract
                                                                      ?.jsonBody ??
                                                                  ''),
                                                            ) as List).map<String>((s) => s.toString()).toList()?.toList(), 0)}',
                                                        'รหัสพนักงาน: -',
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                              ...
                                                              child: custom_widgets
                                                                ...
                                                                widgetPointerTextColor:
                                                                    Colors
                                                                        .white,
                                                                widgetPointerText: functions.showMatNameInList(
                                                                    (GetEmpTargetContractKPIAPICall.productType(
                                                                      (_model.getEmployeeContract
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    ) as List)
                                                              ...
                                                              child: custom_widgets
                                                                ...
                                                                widgetPointerTextColor:
                                                                    Colors
                                                                        .white,
                                                                widgetPointerText: functions.showMatNameInList(
                                                                    (GetEmpTargetContractKPIAPICall.productTypeLM(
                                                                      (_model.getEmployeeContract
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    ) as List)
                                        ...
                                        Expanded(
                                          ...
                                          child: Autocomplete<String>(
                                            ...
                                            fieldViewBuilder: (
                                              ...
                                              _model.branchInputAreaController =
                                                  textEditingController;
                                              return TextFormField(
                                                ...
                                                textAlign: TextAlign.start,
                                                validator: _model
                                                    .branchInputAreaControllerValidator
                                                    .asValidator(context),
                                              );
                                            },
                                          ),
                                  ...
                                  child:
                                    ...
                                    future: queryUrlLinkStorageRecordOnce(
                                      queryBuilder: (urlLinkStorageRecord) =>
                                          urlLinkStorageRecord.where('url_name',
                                              isEqualTo:
                                                  'tableau_ceo_url_link'),
                                      singleRecord: true,
                                    ),
                                          ...
                                          if (functions
                                            ...
                                            await actions.openTableauBrowser(
                                              ...
                                              '${iconButtonUrlLinkStorageRecord!.urlLink}${_model.areaRegionDropDownValue}/${functions.getIndexRegionAreaCEOWelfare(_model.areaRegionDropDownValue == 'เขต' ? (GetRegionAreaAPICall.areaCode(
                                                  (_model.getArea?.jsonBody ??
                                                      ''),
                                                ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList() : (GetRegionAreaAPICall.regionCode(
                                                  (_model.getRegion?.jsonBody ??
                                                      ''),
                                                ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList(), _model.areaRegionDropDownValue == 'เขต' ? functions.getRegionAreaNameCode((GetRegionAreaAPICall.areaName(
                                                    (_model.getArea?.jsonBody ??
                                                        ''),
                                                  ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList(), (GetRegionAreaAPICall.areaCode(
                                                    (_model.getArea?.jsonBody ??
                                                        ''),
                                                  ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList()) : functions.getRegionAreaNameCode((GetRegionAreaAPICall.regionName(
                                                    (_model.getRegion
                                                            ?.jsonBody ??
                                                        ''),
                                                  ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList(), (GetRegionAreaAPICall.regionCode(
                                                    (_model.getRegion
                                                            ?.jsonBody ??
                                                        ''),
                                                  ) as List).map<String>((s) => s.toString()).toList()?.map((e) => e.toString()).toList()?.toList()).toList(), _model.areaRegionSelectedDropDownValue)}${_model.areaRegionDropDownValue == 'เขต' ? '/KPIareamanager/HomePage' : '/KPI_16727986561710/HomePage'}',
                                            );
                                          } else {
                                            await showDialog(
                                              context: context,
