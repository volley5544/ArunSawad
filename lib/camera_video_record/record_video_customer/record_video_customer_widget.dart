...
class RecordVideoCustomerWidget extends StatefulWidget {
  ...
  State<RecordVideoCustomerWidget> createState() =>
      _RecordVideoCustomerWidgetState();
}

class _RecordVideoCustomerWidgetState extends State<RecordVideoCustomerWidget> {
  late RecordVideoCustomerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RecordVideoCustomerModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'RecordVideoCustomer'});
                              ...
                              children: [
                                    ...
                                    Expanded(
                                      child: FlutterFlowChoiceChips(
                                        ...
                                        selectedChipStyle: ChipStyle(
                                          backgroundColor: Color(0xFFD5E0D0),
                                          textStyle:
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Text(
                                        'กรอกเลขที่ใบคำขอหรือเลขที่สัญญา :',
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Poppins',
