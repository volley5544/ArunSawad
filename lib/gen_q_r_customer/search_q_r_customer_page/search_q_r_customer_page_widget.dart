...
import 'search_q_r_customer_page_model.dart';
export 'search_q_r_customer_page_model.dart';

class SearchQRCustomerPageWidget extends StatefulWidget {
  const SearchQRCustomerPageWidget({
    super.key,
  ...
  static String routeName = 'searchQRCustomerPage';
  static String routePath = 'searchQRCustomerPage';

  @override
  State<SearchQRCustomerPageWidget> createState() =>
...
class _SearchQRCustomerPageWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SearchQRCustomerPageModel());
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Visibility(
                        visible: FFAppState().isLoadedSearchCollection,
                        child: RefreshIndicator(
                          ...
                          child: PagedListView<ApiPagingParams, dynamic>(
                            pagingController: _model.setListViewController(
                              (nextPageMarker) =>
                                  CollectionFollowupDebtCall.call(
