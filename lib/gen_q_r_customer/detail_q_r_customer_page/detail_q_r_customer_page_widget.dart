                                                              ...
                                                              builder:
                                                                ...
                                                                child:
                                                                  ...
                                                                  onPressed:
                                                                    ...
                                                                    _shouldSetState =
                                                                        true;
                                                                    if ((_model.qrCodeAPIOutput?.statusCode ??
                                                                            200) !=
                                                                        200) {
                                                                      await showDialog(
                                                                        context:
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              content: Text('พบข้อผิดพลาด Connection (${(_model.qrCodeAPIOutput?.statusCode ?? 200).toString()})'),
                                                                              actions: [
                                                                                TextButton(
                                                                                  onPressed: () => Navigator.pop(alertDialogContext),
                                                                                  child: Text('Ok'),
                                                                      ...
                                                                      await showDialog(
                                                                        ...
                                                                        builder:
                                                                          ...
                                                                          return WebViewAware(
                                                                            child:
                                                                                AlertDialog(
                                                                              content: Text('${PaymentQrGenCall.message(
                                                                                (_model.qrCodeAPIOutput?.jsonBody ?? ''),
                                                                              )}'),
                                                                              actions: [
                                                                                TextButton(
