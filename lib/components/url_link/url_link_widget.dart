...
import 'url_link_model.dart';
export 'url_link_model.dart';
...
class _UrlLinkWidgetState extends State<UrlLinkWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UrlLinkModel());
                              ...
                              child: Builder(
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, leavedocIndex) {
                                      final leavedocItem =
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text(
                                                    'กดเพื่อดูรายละเอียดไฟล์แนบที่ ${(leavedocIndex + 1).toString()}',
