...
class CallHistoryWidget extends StatefulWidget {
  ...
  final List<String>? historyStatusList;
  final List<String>? historyTimeCallList;
                    ...
                    Builder(
                      builder: (context) {
                        ...
                        return ListView.builder(
                          ...
                          itemCount: callStatusListView.length,
                          itemBuilder: (context, callStatusListViewIndex) {
                            final callStatusListViewItem =
                                callStatusListView[callStatusListViewIndex];
                            return Container(
                              width: double.infinity,
                              decoration: BoxDecoration(
