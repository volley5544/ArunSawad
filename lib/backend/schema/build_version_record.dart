...
class BuildVersionRecord extends FirestoreRecord {
  ...
  // "lead_open_on_web" field.
  bool? _leadOpenOnWeb;
  bool get leadOpenOnWeb => _leadOpenOnWeb ?? false;
  bool hasLeadOpenOnWeb() => _leadOpenOnWeb != null;
  ...
  void _initializeFields() {
    ...
    _leadOpenOnWeb = snapshotData['lead_open_on_web'] as bool?;
  }
...
Map<String, dynamic> createBuildVersionRecordData({
  ...
  final firestoreData = mapToFirestore(
    <String, dynamic>{
      ...
      'lead_open_on_web': leadOpenOnWeb,
    }.withoutNulls,
  );
...
class BuildVersionRecordDocumentEquality
  ...
  bool equals(BuildVersionRecord? e1, BuildVersionRecord? e2) {
    return e1?.appVersion == e2?.appVersion &&
        ...
        e1?.leadOpenOnWeb == e2?.leadOpenOnWeb;
  }
