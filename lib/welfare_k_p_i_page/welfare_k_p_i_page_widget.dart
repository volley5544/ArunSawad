...
class WelfareKPIPageWidget extends StatefulWidget {
  const WelfareKPIPageWidget({Key? key}) : super(key: key);

  @override
  _WelfareKPIPageWidgetState createState() => _WelfareKPIPageWidgetState();
}
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Visibility(
                                      visible: tabBarTextContentRecord!
                                              .kpiHideText ??
                                          true,
                                      child: Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                                  ...
                                                  FlutterFlowTheme.of(context)
                                                      ...
                                                      .override(
                                                        ...
                                                        color: valueOrDefault<
                                                            Color>(
                                                          functions.getKpiWelfareStatusTextColor(
                                                              ((_model.getKpiWelfareCurrentMonth?.statusCode ?? 200) == 200) &&
                                                                      (GetWelfareKpiCurrentMonthAPICall.statusLayer2(
                                                                            (_model.getKpiWelfareCurrentMonth?.jsonBody ??
                                                                                ''),
                                                                          ) ==
                                                                          200)
                                                                  ...
                                                                  : '0',
                                                              FFAppState().welfareKpiStatusTextColorList.toList(),
                                                              functions.getMaxValueWelfareKpi(((_model.getKpiWelfareCurrentMonth?.statusCode ?? 200) == 200) &&
                                                                      (GetWelfareKpiCurrentMonthAPICall.statusLayer2(
                                                                            (_model.getKpiWelfareCurrentMonth?.jsonBody ??
                                                                                ''),
                                                                          ) ==
                                                                          200)
                                                                  ? GetWelfareKpiCurrentMonthAPICall.percentTarget(
                                                                      (_model.getKpiWelfareCurrentMonth
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    ).toString()
                                                  ...
                                                  FlutterFlowTheme.of(context)
                                                      ...
                                                      .override(
                                                        ...
                                                        color: valueOrDefault<
                                                            Color>(
                                                          functions.getKpiWelfareStatusTextColor(
                                                              ((_model.getKpiWelfareLastMonth?.statusCode ?? 200) == 200) &&
                                                                      (GetWelfareKpiLastMonthAPICall.statusLayer2(
                                                                            (_model.getKpiWelfareLastMonth?.jsonBody ??
                                                                                ''),
                                                                          ) ==
                                                                          200)
                                                              ...
                                                              ((_model.getKpiWelfareLastMonth?.statusCode ?? 200) == 200) &&
                                                                      (GetWelfareKpiLastMonthAPICall.statusLayer2(
                                                                          ...
                                                                          200)
                                                                  ? functions.getMaxValueWelfareKpi(GetWelfareKpiLastMonthAPICall.percentTarget(
                                                                      (_model.getKpiWelfareLastMonth
                                                                              ?.jsonBody ??
                                                                          ''),
                                                                    ).toString())
