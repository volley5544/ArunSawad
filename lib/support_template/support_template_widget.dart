...
import 'support_template_model.dart';
export 'support_template_model.dart';

class SupportTemplateWidget extends StatefulWidget {
  const SupportTemplateWidget({Key? key}) : super(key: key);

  @override
  _SupportTemplateWidgetState createState() => _SupportTemplateWidgetState();
}

class _SupportTemplateWidgetState extends State<SupportTemplateWidget> {
  late SupportTemplateModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SupportTemplateModel());
